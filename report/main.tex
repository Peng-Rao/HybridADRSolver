...
For the matrix-free implementation, \texttt{deal.II}'s native distributed vectors (\texttt{LinearAlgebra::distributed::Vector}) are used, which support MPI-parallel operations with ghost value exchange.
